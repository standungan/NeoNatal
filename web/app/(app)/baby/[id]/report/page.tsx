...
import { ObservationRadar, categoryColor, PILLAR_SHORT } from "@/components/observation";
      ...
      <PageState loading={isLoading} error={error} onRetry={() => refetch()}>
        {data && (
          <div className="flex flex-col gap-4">
            ...
            {latestObservation && <ObservationReportCard record={latestObservation} />}
...
function ObservationReportCard({ record }: { record: ObservationRecord }) {
  return (
    <Card className="p-5">
